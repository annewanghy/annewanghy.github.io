        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, i, k) {
                ...
                (function() {
                    ...
                    function pa(a) {
                        a.instance = S, a.callMethod = U, a._initHandlers = [], a._initsDone = {}, a.send = Z, a.getEventCustomParameters = ka, a.addInitHandler = na, a.getState = oa, a.init = W, a.set = V, a.loadPlugin = function(a) {
